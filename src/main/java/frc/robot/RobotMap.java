...
public class RobotMap {
  ...
  //public static final int CONTROLSTICK_PORT = 1;
    ...
    //Intestine motors ID (Cans)
    public static final int BELT_ONE_MOTOR_ID = -1;
    public static final int BELT_TWO_MOTOR_ID = -1;

    //IR Sensors/Digital Inputs roborio dio ports
    public static final int IR_SENSOR_ONE = 0;
    public static final int IR_SENSOR_TWO = -1;
